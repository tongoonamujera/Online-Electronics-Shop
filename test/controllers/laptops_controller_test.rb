...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { Condition: @laptop.Condition, LaptopName: @laptop.LaptopName, Location: @laptop.Location, Memory: @laptop.Memory, Price: @laptop.Price } }
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { Condition: @laptop.Condition, LaptopName: @laptop.LaptopName, Location: @laptop.Location, Memory: @laptop.Memory, Price: @laptop.Price } }
