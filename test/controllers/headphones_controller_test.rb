...
class HeadphonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create headphone" do
    assert_difference('Headphone.count') do
      post headphones_url, params: { headphone: { Condition: @headphone.Condition, LaptopName: @headphone.LaptopName, Location: @headphone.Location, Memory: @headphone.Memory, Price: @headphone.Price } }
    end
  ...
  test "should update headphone" do
    patch headphone_url(@headphone), params: { headphone: { Condition: @headphone.Condition, LaptopName: @headphone.LaptopName, Location: @headphone.Location, Memory: @headphone.Memory, Price: @headphone.Price } }
